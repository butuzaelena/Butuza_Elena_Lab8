...
namespace Butuza_Elena_Lab8.Models
{
    public class BookCategoriesPageModel : PageModel
    {
        public List<AssignedCategoryData> AssignedCategoryDataList;
        public void PopulateAssignedCategoryData(Butuza_Elena_Lab8Context context,
        Book book)
        {
        ...
        public void UpdateBookCategories(Butuza_Elena_Lab8Context context,
